...
class DGCard extends StatelessWidget {
 ...
 final  bool clickable;
  final ValueChanged<DG> onSelected;
  DGCard({Key? key,   required this.clickable, required this.product, required this.onSelected}) : super(key: key);
  @override
                ...
                Expanded(
                  child: Stack(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(height: 65, child:  Center(child: Image.asset(product.path)))
                    ],
                  ),
                ),
                // SizedBox(height: 5),
