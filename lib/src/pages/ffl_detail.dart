...
class FflDetailPage extends StatefulWidget {
  FflDetailPage({Key? key}) : super(key: key);

  @override
  FflDetailPageState createState() => FflDetailPageState();
}

class FflDetailPageState extends State<FflDetailPage>
